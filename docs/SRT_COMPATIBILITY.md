...
| Spaces/tabs/no spaces around literal `-->`; comma or dot milliseconds | Public: exactly three fractional digits and two-digit clock fields | Provider: 1–6 digit integer fields; 1–3 digit decimal fractional seconds | `srt::tests::compatible_layout_corpus_preserves_every_text_and_time_field` (48 combinations); provider counterpart (36 combinations); `timestamp_spelling_is_numeric_not_guessed_precision_or_overflow` |
